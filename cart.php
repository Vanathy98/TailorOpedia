                ...
                <div id="cart" class="bg-white rounded-20 my-4">
                    <div class="card-body p-4">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col-lg-2">
                                <img src="assets/image/card-image.png" class="img-fluid rounded-3" alt="Cotton T-shirt">
                            </div>
                            <div class="col-lg-5">
                                <h3 class="mb-2">Kurti-A Line From Bust</h3>
                                <small>Stitching Name : ddeesss</small>
