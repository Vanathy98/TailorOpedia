            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="details.html">
                            <div class="card">
                                <!-- Image -->
                                <div class="header">
                                    <img src="assets/image/Rectangle-1.png" class="img-fluid" alt="">
                                </div>
                                <!-- Content -->
                                <div class="body">
                                    <!-- Title and review -->
                    ...
                    <div class="col-lg-4">
                        <a href="details.html">
                            <div class="card">
                                <!-- Image -->
                                <div class="header">
                                    <img src="assets/image/Rectangle.png" class="img-fluid" alt="">
                                </div>
                                <!-- Content -->
                                <div class="body">
                                    <!-- Title and review -->
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                    <?php
                        $sql = "SELECT * FROM completed_product";
                    ...
                    ?>
                               <div class="col-lg-4">
                                    <a href="details.html">
                                        ...
                                        <!-- Image -->
                                        <div class="header">
                                        <?php echo '<img class="img-fluid" src="data:image/jpeg;base64,'. base64_encode($img) .'"/>'?>
                                        </div>
                                        <!-- Content -->
                                        <div class="body">
                                            <!-- Title and review -->
